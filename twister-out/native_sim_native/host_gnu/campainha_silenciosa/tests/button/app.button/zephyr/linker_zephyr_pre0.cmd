...
ztest :
{
 ...
 zbus_channel_area : { _zbus_channel_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_channel.static.*))); _zbus_channel_list_end = .;; }
 zbus_observer_area : { _zbus_observer_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_observer.static.*))); _zbus_observer_list_end = .;; }
 zbus_channel_observation_area : { _zbus_channel_observation_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_channel_observation.static.*))); _zbus_channel_observation_list_end = .;; }
 symbol_to_keep :
 {
...
datas :
{
 ...
 zbus_channel_observation_mask_area : { _zbus_channel_observation_mask_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_channel_observation_mask.static.*))); _zbus_channel_observation_mask_list_end = .;; }
native_pre_tasks :
{
