...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_DUMMY_CODEC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_NATIVE_PTP_CLOCK_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_NATIVE_SIM_DMIC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_NATIVE_SIM_I2S_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DEVICE_API_ASSERT, 1);
