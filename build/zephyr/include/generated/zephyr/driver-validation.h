...
#define K_SYSCALL_DRIVER_CLOCK_MONITOR(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, clock_monitor, CLOCK_MONITOR)
...
#define K_SYSCALL_DRIVER_MEMC(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, memc, MEMC)
