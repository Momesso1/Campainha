 ...
 *(.rela.*)
 ...
 zbus_channel_observation_mask_area : ALIGN_WITH_INPUT { _zbus_channel_observation_mask_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_channel_observation_mask.static.*))); _zbus_channel_observation_mask_list_end = .;; } > dram0_0_seg AT > FLASH
